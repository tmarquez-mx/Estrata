...
**(English version - AI generated)**  Estrata is a personal research blog that experiments with academic writing forms unable to fit within the conventional article — not a service platform or journal, but a space for essayistic experimentation where each post functions simultaneously as text and as proof-of-concept for a format. The project responds to a structural discomfort in inherited academic writing: it presumes a reader moving linearly toward a conclusion, an author who erases doubt before publication, and a data apparatus relegated to appendix or discarded altogether. This format no longer describes how scholarly work actually happens — writing now occurs with tools that suggest, summarize, and propose; reading jumps across tabs; verification happens concurrently with drafting. Human–machine collaboration is already underway, yet the traditional format forces it to remain invisible, as though acknowledging it would compromise the result. Estrata inverts this logic, making the collaboration visible and organizing it into distinct layers, each demanding a different cognitive operation — following an argument, suspecting it, and inspecting its underlying materials — which together account for how a claim is constructed more fully than any single layer alone. The project's guiding question asks what forms of knowledge production, reading, and interpretation become possible once an academic publication ceases to be a closed object and becomes an explorable architecture of texts, interpretations, and data. Building on the multilayered publication principle developed by the Journal of Digital History — which articulates scholarly narrative, methodological reflection, and documentary or computational materials — Estrata adapts this model to an AI-assisted writing environment through three complementary layers.
...
Este repositorio contiene el [**prototipo navegable v0.1**](https://tmarquez-mx.github.io/Estrata/) de Estrata: un único archivo HTML autónomo que demuestra las funciones centrales de la propuesta.
...
[**clic aquí **](https://tmarquez-mx.github.io/Estrata/)
